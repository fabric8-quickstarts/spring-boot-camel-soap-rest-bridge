...
The actual endpoint is using the _context-path_ `camel-soap-rest-bridge/users` and the REST service provides two services:
...
- <http://spring-boot-camel-soap-rest-bridge-MY_PROJECT_NAME.OPENSHIFT_IP_ADDR.nip.io/camel-soap-rest-bridge/users/greet>
- <http://spring-boot-camel-soap-rest-bridge-MY_PROJECT_NAME.OPENSHIFT_IP_ADDR.nip.io/camel-soap-rest-bridge/users/list>

== OpenApi API

The example provides API documentation of the service using Swagger using the _context-path_ `camel-soap-rest-bridge/api-doc`. You can access the API documentation from your Web browser at <http://spring-boot-camel-soap-rest-bridge-MY_PROJECT_NAME.OPENSHIFT_IP_ADDR.nip.io/camel-soap-rest-bridge/api-doc>.
...
+
----
$ java -jar -Dspring.profiles.active=dev target/spring-boot-camel-soap-rest-bridge-1.0-SNAPSHOT.jar
----

. You can then access the REST API directly from your Web browser, e.g.:

- <http://localhost:8080/camel-soap-rest-bridge/users/greet>
- <http://localhost:8080/camel-soap-rest-bridge/users/list>
