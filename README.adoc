...
----
        ...
        keytool -delete -noprompt -trustcacerts -alias openshift -keystore src/main/resources/openshiftcerts
        keytool -import -noprompt -alias openshift -keystore src/main/resources/openshiftcerts -file sso.crt
----      
