...
2. This test contains 5 test cases, demonstrates 5 different scenarios
   1. testJavaClient(elaboration)
   2. testRestClientWithInvalidPayload(elaboration)
   3. testRestClientWithSTS(elaboration)
   4. testRestClientWithIncorrectToken(elaboration)
   5. testRestClientWithSTSInvalidZipCode(elaboration)
